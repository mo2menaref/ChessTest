...
class PlayerList extends StatefulWidget {
  final String roomId;  // Add required roomId parameter
...
class _PlayerListState extends State<PlayerList> {
  ...
  // Add the missing updatePoints function
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      // Show electric symbol if player has it
                      if (hasElectric) ...[
                        Container(
                          padding: EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                          decoration: BoxDecoration(
                            color: Colors.yellow[700], // Changed back to yellow for electric
                        ...
                        onSelected: (value) {
                          if (value == 'update') {
                            RoomDialogs.showUpdatePointsDialog(
                              ...
                              pointsController: _pointsController,
                              onUpdate: () => _updatePoints(player.id), // Fixed function call
                            );
